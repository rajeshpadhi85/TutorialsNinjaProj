...
public class RegisterPage {
	...
	public void selectPrivaryPolicy() {
		privacyPolicyField.click();
	}
	public AccountSuccessPage clickOnContinueButtone() {
	...
	public String retriveLastNameWarning() {
		String lastNameWarningText=lastNameWaring.getText();
	...
	public boolean displayStatusOfWarningMessage(String expectedPrivacyPolicyWarning, String expectedFirstNameWarning, String expectedLastNameWarning,String expectedEmailWarning,String expectedTelephoneWarning,String expectedPasswordWaring) {
		...
		boolean lastNameWarningStatus=lastNameWaring.getText().equals(expectedLastNameWarning);
